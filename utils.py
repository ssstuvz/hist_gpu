...
############ WRITE DIFFERENT HISTOGRAM KERNELS HERE ###############
...
def fill_histogram(res, arr, target, nodes, col_indexer, row_indexer, out_indexer, func=0):
        ...
        for k in range(0, nout, out_batch):
            ...
            if func == 0:
                ...
                histogram_kernel_idx(ri, ti_, oi_,
                                     ...
                                     res)
            # Add flags to use other solutions here
            # e.g.
            # if func == 1:
            #    histogram_kernel_raw(...)
            # if func == 2:
            #    histogram_kernel_raw_shared_memory(...)
            # etc.
